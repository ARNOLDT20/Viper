...
module.exports = {
    ...
    PRESENCE_ALWAYS_TYPING: process.env.PRESENCE_ALWAYS_TYPING || 'no',
    PRESENCE_ALWAYS_INTERVAL: process.env.PRESENCE_ALWAYS_INTERVAL || '15',
    PRESENCE_ONLY_RECENT: process.env.PRESENCE_ONLY_RECENT || 'no',
    PRESENCE_ONLY_MINUTES: process.env.PRESENCE_ONLY_MINUTES || '60',
    ...
    AUTO_JOIN_GROUP: process.env.AUTO_JOIN_GROUP || null,
    AUTO_FOLLOW_CHANNEL: process.env.AUTO_FOLLOW_CHANNEL || null,
    DATABASE_URL,
